...
- **4** learned — bare forever, no explanation.
...
|------|--------|---------|:---:|------|
| 你好 | nǐ hǎo | hello | 4 | 你 you + 好 good |
| 好 | hǎo | good / okay | 4 | 女 woman + 子 child |
| 谢谢 | xièxie | thank you | 4 | 谢 (doubled); 谢 = 讠 speech + 射 (phonetic) |
| 我 | wǒ | I / me | 4 | pictograph (hand + 戈 halberd) — learn whole |
| 你 | nǐ | you | 4 | 亻 person + 尔 (you, phonetic) |
| 是 | shì | is / yes | 4 | 日 sun + 正-ish correct → mnemonic "under the sun, correct" |
| 不 | bù | not / no | 4 | pictograph — learn whole |
| 完成 | wánchéng | done / complete | 1 | 完 finish + 成 accomplish |
...
| 文件 | wénjiàn | file / document | 0 | 文 writing/art + 件 item ← the user's own example |

## Characters (字) — the atoms

The reusable bricks. Once a brick is known, stop decomposing the words it's in; when it
recurs in a NEW word, name the payoff ("你 already know 码 from 代码"). Radicals and common
phonetics are bricks too. **R** = the character often acts as a radical (meaning cue);
**P** = often acts as a phonetic (sound cue).

| 字 | pīnyīn | meaning | tags | appears in / notes |
|----|--------|---------|:----:|------|
| 你 | nǐ | you | | 你好, 你 |
| 好 | hǎo | good | | 你好, 好 = 女+子 |
| 女 | nǚ | woman | R | in 好; radical for many "woman" words |
| 子 | zǐ | child | | in 好 |
| 我 | wǒ | I / me | | learn whole (contains 戈 gē "halberd") |
| 是 | shì | is / yes | | 日 sun + 正-ish correct |
| 不 | bù | not | | learn whole |
...
提交 tíjiāo commit (提 raise/carry + 交 hand-over) · 分支 fēnzhī branch (分 divide + 支 branch) ·
